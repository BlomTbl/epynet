...
MAXFNAME = 59  # /* Max. # characters in file name         */
...
_statistics = {0: "Report all time series points",
               1: "Report average value over simulation period",
               2: "Report minimum value over simulation period",
               3: "Report maximum value over simulation period",
               4: "Report maximum - minimum over simulation period"}
...
class EpanetOutBin(object):
    ...
    def open(self):
        ...
        self.CODEVERSION = Prolog[1]  # version
        self._Nnodes = Prolog[2]  # Number of Nodes (Junctions + Reservoirs + Tanks)
        self._Ntanks = Prolog[3]  # Number of Reservoirs & Tanks
        self._Nlinks = Prolog[4]  # Number of Links (Pipes + Pumps + Valves)
        self._Npumps = Prolog[5]  # Number of Pumps
        self._Nvalves = Prolog[6]  # Number of Valves
        Tstatflag = Prolog[11]
        Rstart = Prolog[12]
        Rstep = Prolog[13]
